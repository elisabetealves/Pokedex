...
import { InfoContainer, PageContainer, Img, InfoCenterDiv, ButtonContainer, DivMove } from './styled'
...
import { goToPokemonDetailsPage } from '../../routes/coodinator'
...
const PokemonDetailsPage = (props) => {
   ...
   return (
      <>
         <Header page="details" />
         <PageContainer>
            {pokemonData.types && <Box className="BoxOne" bgGradient={`linear(to top, #f8f6f45a 0.05%, ${colors[pokemonData.types[0].type.name]} 80%, ${colors[pokemonData.types[0].type.name]} 50%)`}
